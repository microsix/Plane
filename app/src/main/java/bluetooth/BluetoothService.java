...
public class BluetoothService {
    ...
    private synchronized void setState(int state) {
        if (DEBUG) {
            ...
            // TODO apply handle after setup bluetoothchat
            mHandler.obtainMessage(Constant.MESSAGE_STATE_CHANGE, state,
                    -1).sendToTarget();
        }
    }
    ...
    public synchronized void connected(BluetoothSocket socket,
        ...
        // Send the name of connected device back to the UI Activity
                    ...
                    synchronized (BluetoothService.this) {
                        ...
                        case STATE_CONNECTED:
                            ...
                            try {
                                ...
                                Log.e(TAG, "Could not clode unwanted socket", e);
                            }
                            break;
                        }
                    }
     ...
     * device. It runs straight through; the connection either succeeds of
     * fails.
     */
    private class ConnectedThread extends Thread {
        ...
        public void write(byte[] buffer) {
            try {
                ...
                mHandler.obtainMessage(Constant.MESSAGE_WRITE, -1, -1,
                        buffer).sendToTarget();
            } catch (IOException e) {
